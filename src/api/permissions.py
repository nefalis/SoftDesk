...
class ProjectPermission(permissions.BasePermission):
    """
    permission pour qu'il n'y ai que l'auteur
    du projet qui puisse modifier ou supprimer
    """
...
class ContributorPermission(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        # Pour les actions d'écriture, vérifiez
        # si l'utilisateur est contributeur du projet associé
